...
class TestBus(unittest.TestCase):
    ...
    def test_can_pick_up_passenger_from_bus_stop(self):
        ...
        instance_of_bus_stop = BusStop("Waverly Station")
        instance_of_bus_stop.add_to_queue(person_1)
        instance_of_bus_stop.add_to_queue(person_2)
        self.bus.pick_up_from_stop(instance_of_bus_stop)
